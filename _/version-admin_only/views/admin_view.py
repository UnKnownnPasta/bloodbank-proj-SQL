...
def main_frame_handle():
    ...
    menu_btn = Button(title_bar, image=globalImages[7], **btnLooks, command= lambda: side_bar(hosp_id))
    menu_btn.pack(side=LEFT)
    logo_lbl = Label(title_bar, bg="#D22B2B", image=globalImages[3])
    ...
    profile_btn = create_button(title_bar, '', 830, 2, background='#D22B2B', activebackground='#D22B2B',
        image=globalImages[5], command= lambda: sub_profile_view())

    home_btn = create_button(title_bar, '', 880, 2, background='#D22B2B', activebackground='#D22B2B',
        image=globalImages[8], command=lambda: home_page())
    ...
    def home_page():
        ...
        bg = Label(visible_frame, image=globalImages[2])
        bg.place(x=-2, y=-2)
        bg.lower()
...
def sub_profile_view():
    ...
    profCanvas.create_image(0, 0, image=globalImages[1], anchor=NW)
    profCanvas.create_image(53, 53, image=globalImages[5], anchor=NW)
